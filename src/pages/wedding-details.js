        ...
        <div className="body-container">
            ...
            <div className={styles.bigEvent}>
                <div className={styles.info}>
                    ...
                    <div className={styles.desc}>
                        Everyone is welcome to join us for drinks and bites as we celebrate the start
                        of an incredible wedding weekend.
                    </div>
                </div>
                <div className={styles.schedule}>
                    <div className={styles.scheduleTitle}>Schedule</div>

                    <div className={styles.event}>TBA</div>
                </div>
            </div>
            ...
            <div className={styles.bigEvent}>
                <div className={styles.info}>
                    ...
                    <div className={styles.desc}>
                        ...
                        flowers, family, and the people we adore most. Cozy, heartfelt, and filled
                        with moments we'll remember forever.
                    </div>
                </div>
            ...
            <div className={styles.bigEvent}>
                <div className={styles.info}>
                    ...
                    <div className={styles.desc}>
                        Join us the morning after the wedding for a laid-back poolside brunch with
                        light bites.
                    </div>
                </div>
                <div className={styles.schedule}>
