    ...
    <div className="body-container">
      ...
      <section className={styles.storySection}>
        <div className={styles.sectionTitle}>
          <span className={styles.word}><span className={styles.letter}>H</span>er</span>
          <span className={styles.word}><span className={styles.letter}>S</span>tory</span>
        </div>
      ...
      <section className={styles.storySection}>
        <div className={styles.sectionTitle}>
          <span className={styles.word}><span className={styles.letter}>H</span>is</span>
          <span className={styles.word}><span className={styles.letter}>S</span>tory</span>
        </div>
        <div className={styles.story}>
          <p>
            We met in Business Information Systems at SF State. The first day she walked into class, 
            wearing her hat and glasses, I noticed her immediately. Her warm smile, kind eyes, and calm energy stood out. 
            She sat next to me, which I jokingly tell her was her first move. My first move was asking her to hang out after finals.
          </p>
          <p>
            In my memory, our first date was at Stern Grove, where we walked and talked for what felt like hours. 
            I remember feeling comfortable right away, as if I had known her much longer than just a few months.
          </p>
          <p>
            I knew she was the one during our first group project together. Her dedication, positivity, responsibility, 
            and proactive nature showed me exactly who she was. Everything about her aligned with what I hoped for in a partner.
          </p>
          <p>
            When it came time for the proposal, I felt confident and excited. I knew she would love the moment, the setting, 
            and the thought behind it. I was simply looking forward to the joy on her face.
          </p>
        </div>
        <div className={styles.storyImageCard}>
          <Image
